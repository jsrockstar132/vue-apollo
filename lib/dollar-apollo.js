...
var DollarApollo = exports.DollarApollo = function () {
  ...
  _createClass(DollarApollo, [{
    ...
    value: function query(options) {
      ...
      var res = this.getClient(options).query(options);
      res.then(function () {
        return _this.updateLoadingKey(options, false);
      }, function () {
        return _this.updateLoadingKey(options, false);
      });
      return res;
    ...
    value: function mutate(options) {
      ...
      this.updateLoadingKey(options, true);
      var res = this.getClient(options).mutate(options);
      res.then(function () {
        return _this3.updateLoadingKey(options, false);
      }, function () {
        return _this3.updateLoadingKey(options, false);
      });
      return res;
    ...
    key: 'updateLoadingKey',
    value: function updateLoadingKey(options, isIncrement) {
    ...
    value: function subscribe(options) {
      ...
      observable.subscribe = function (options) {
        var sub = _subscribe(options);
        _this4._apolloSubscriptions.push(sub);
        return sub;
      };
      return observable;
    }
