...
var SmartQuery = exports.SmartQuery = function (_SmartApollo) {
  ...
  _createClass(SmartQuery, [{
    ...
    value: function refetch(variables) {
      ...
      if (this.observer) {
        var result = this.observer.refetch(variables);
        this.maySetLoading();
        return result;
      }
    }
...
var SmartSubscription = exports.SmartSubscription = function (_SmartApollo2) {
  ...
  function SmartSubscription(vm, key, options) {
    ...
    var _this4 = _possibleConstructorReturn(this, (SmartSubscription.__proto__ || Object.getPrototypeOf(SmartSubscription)).call(this, vm, key, options, autostart));

    _this4.type = 'subscription';
    _this4.vueApolloSpecialKeys = ['variables', 'result', 'error', 'throttle', 'debounce'];
    return _this4;
  }
